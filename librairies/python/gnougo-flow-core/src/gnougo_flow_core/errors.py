...
class ErrorCodes:
    ...
    DECISION_EVALUATION_UNRESOLVED = "DECISION_EVALUATION_UNRESOLVED"
    ...
    CAPABILITY_PREFLIGHT_UNAVAILABLE = "CAPABILITY_PREFLIGHT_UNAVAILABLE"
    CAPABILITY_PREFLIGHT_DISCOVERY_FAILED = "CAPABILITY_PREFLIGHT_DISCOVERY_FAILED"
    CAPABILITY_PREFLIGHT_INFERENCE_FAILED = "CAPABILITY_PREFLIGHT_INFERENCE_FAILED"
    CAPABILITY_PREFLIGHT_REDUNDANT_ARTIFACT_PRODUCER = "CAPABILITY_PREFLIGHT_REDUNDANT_ARTIFACT_PRODUCER"
    WORKFLOW_PLAN_REPAIR_STALLED = "WORKFLOW_PLAN_REPAIR_STALLED"
    WORKFLOW_FINALIZATION_FAILED = "WORKFLOW_FINALIZATION_FAILED"
    WORKFLOW_FINALIZATION_TIMEOUT = "WORKFLOW_FINALIZATION_TIMEOUT"
