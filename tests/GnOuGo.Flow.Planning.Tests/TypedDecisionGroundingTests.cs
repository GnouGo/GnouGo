...
public sealed class TypedDecisionGroundingTests
{
    ...
    {
        var owner = typeof(CapabilityDecisionGrounding);
        Type T(string name) => typeof(CapabilityContracts).GetNestedType(name, BindingFlags.NonPublic)!;
    ...
    {
        var t = typeof(CapabilityDecisionGrounding);
        var flags = System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Static;
        Func<string, Type> T = n => typeof(CapabilityContracts).GetNestedType(n, System.Reflection.BindingFlags.NonPublic)!;
