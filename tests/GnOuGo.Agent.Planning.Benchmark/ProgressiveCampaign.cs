...
internal static class ProgressiveCampaign
{
    ...
    internal const string CampaignId = "schema5-declaration-constraints-stage1-1";
    private const string PreviousCampaignId = "schema5-neutral-declarations-stage1-1";
