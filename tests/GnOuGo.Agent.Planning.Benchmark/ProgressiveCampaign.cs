...
internal static class ProgressiveCampaign
{
    ...
    internal const string CampaignId = "schema5-declaration-constraints-stage1-rerun-1";
    private const string PreviousCampaignId = "schema5-declaration-constraints-stage1-1";
