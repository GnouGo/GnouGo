...
| **GnOuGo.Assets.Animation** (.NET) | NuGet-ready | local source | <img src="https://img.shields.io/badge/.NET-10.0-blue.svg" alt="GnOuGo.Assets.Animation .NET 10.0"> | n/a | AOT-friendly semantic SVG renderer and autonomous workflow-preview simulator. See [`src/GnOuGo.Assets.Animation/README.md`](src/GnOuGo.Assets.Animation/README.md). |
