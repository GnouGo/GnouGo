...
The model schema restricts alternatives recursively to literals, requires at least two alternatives or parallel branches, and requires nonblank questions/objectives. It expresses item ceilings of 1–10,000, concurrency ceilings of 1–100, predicate arity (one for `not`, two otherwise), and array item types. Semantic validation still enforces identity uniqueness, reference visibility, typed contracts and recommendation membership.
