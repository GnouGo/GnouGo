...
internal sealed class PlanningAssessmentPatches
{
    ...
    internal PlanningAssessmentPatches(JsonObject candidate, IReadOnlyList<PlanningDiagnostic> diagnostics,
        IEnumerable<string> evidence, IReadOnlyDictionary<string, string> locations)
    {
        ...
        Schema = new JsonObject { ["type"] = "object", ["additionalProperties"] = false, ["properties"] = properties,
