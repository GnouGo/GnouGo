...
{
    internal const string Collection = "agent-planning-model-receipts-v8";
    internal const string RequestCollection = "agent-planning-model-requests-v8";
...
{
    internal const string Collection = "agent-planning-budgets-v8";
