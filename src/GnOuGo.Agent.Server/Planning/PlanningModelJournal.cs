...
{
    internal const string Collection = "agent-planning-model-receipts-v9";
    internal const string RequestCollection = "agent-planning-model-requests-v9";
...
{
    internal const string Collection = "agent-planning-budgets-v9";
