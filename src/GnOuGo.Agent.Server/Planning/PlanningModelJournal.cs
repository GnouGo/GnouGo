...
{
    internal const string Collection = "agent-planning-model-receipts-v7";
    internal const string RequestCollection = "agent-planning-model-requests-v7";
...
{
    internal const string Collection = "agent-planning-budgets-v7";
