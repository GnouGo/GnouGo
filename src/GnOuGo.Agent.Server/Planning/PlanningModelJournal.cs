...
{
    internal const string Collection = "agent-planning-model-receipts-v10";
    internal const string RequestCollection = "agent-planning-model-requests-v10";
...
{
    internal const string Collection = "agent-planning-budgets-v10";
