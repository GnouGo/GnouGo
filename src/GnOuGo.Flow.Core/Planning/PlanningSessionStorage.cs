...
{
    public const string IncompatibleMessage = "This planning session is incompatible with schema 9. Regenerate and approve the workflow. Its original record is unchanged.";
