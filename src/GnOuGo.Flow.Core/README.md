...
and durable correction lineage. Independent runtime-evidence records distinguish planning, contract and policy evidence from generated-workflow actions. ConstraintsOnly runtime records have engine-source-authority origin and fixed policy scope; they contain no model-selected action authority. Canonical operation proofs bind owned action/resource references, exact baseline authority, action/governing evidence and declaration coverage to existing obligations; preliminary classifications grant no action authority. Canonical root identity and governing target sets are adjudicated after interpretation; source-clause IDs cannot target operations. Assignment disposition and resolution origin survive encrypted restart. Local processing grants no external capability authority. Coupled correction pages may retain coordinator-owned
