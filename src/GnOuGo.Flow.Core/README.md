...
and durable correction lineage. Independent runtime-evidence records distinguish planning, contract and policy evidence from generated-workflow actions. ConstraintsOnly runtime records have engine-source-authority origin and fixed policy scope; they contain no model-selected action authority. Canonical operation proofs bind owned action/subject references, exact baseline authority, runtime evidence and declaration coverage to existing obligations; preliminary classifications grant no action authority. Local processing grants no external capability authority. Coupled correction pages may retain coordinator-owned
