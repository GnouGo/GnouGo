...
{
    internal const string Requests = "flow-planning-model-requests-v6";
    internal const string Receipts = "flow-planning-model-receipts-v6";
...
{
    internal const string Collection = "flow-planning-budgets-v6";
