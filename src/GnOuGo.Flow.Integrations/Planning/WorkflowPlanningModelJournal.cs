...
{
    internal const string Requests = "flow-planning-model-requests-v7";
    internal const string Receipts = "flow-planning-model-receipts-v7";
...
{
    internal const string Collection = "flow-planning-budgets-v7";
