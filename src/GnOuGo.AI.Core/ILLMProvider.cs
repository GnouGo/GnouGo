...
/// <summary>
/// Abstraction for an LLM provider backend (OpenAI, Ollama, Copilot, Anthropic, Azure, etc.).
...
{
    /// <summary>
    /// Unique type identifier for this provider (e.g. "openai", "ollama", "copilot", "anthropic").
