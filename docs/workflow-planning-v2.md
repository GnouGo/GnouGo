...
3. **GroundedPlan:** exact capability bindings, technical arguments, explicit computations and adapters, with mappings back to semantic actions and required business outputs.
